  ...
  const items = [
    {
      ...
      desc_he: "630+ מילים ב-63 סטים מדורגים, עם השמעה, חידון ובדיקות איות",
      desc_en: "630+ words across 63 graded sets, with pronunciation, quiz and spelling drills",
    },
    {
      to: "/qa",
      icon: ClipboardCheck,
      ...
      desc_he: "200+ שאלות נפוצות בראיונות QA, מסודרות לפי נושאים",
      desc_en: "200+ common QA interview questions organized by topic",
    },
    {
      to: "/software",
      icon: Code2,
